...
package com.example.sleeptracker_kotlin
...
fun formatNights(nights: List<SleepingEntity>, resources: Resources): Spanned {
    ...
    sb.apply {
        ...
        nights.forEach {
            ...
            append("\t${convertLongToDateString(it.startNight)}<br>")
            if (it.endTime != it.startNight) {
                ...
                // Hours
                append("\t ${it.endTime.minus(it.startNight) / 1000 / 60 / 60}:")
                // Minutes
                append("${it.endTime.minus(it.startNight) / 1000 / 60}:")
                // Seconds
                append("${it.endTime.minus(it.startNight) / 1000}<br><br>")
            }
        }
    }
